...
2. Сопоставить каждое замечание с конкретным файлом/строкой.
3. Исправлять сразу в коде (не ограничиваться планом).
4. После фиксов прогнать проверки.
5. Вернуть отчёт: что исправлено, что не исправлено, почему.
